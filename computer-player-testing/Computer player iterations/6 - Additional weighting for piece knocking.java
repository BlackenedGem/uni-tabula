...
public class ComputerPlayer implements PlayerInterface {
	...
	private static final double WEIGHT_PIECES_HOME = 0.1;
	...
	private double scoreTurn(TurnInterface turn, BoardInterface boardBefore, Colour colour, List<Integer> diceValues) {
		...
		// Weight knocked off pieces more if they are further along
		...
		// Get the number of pieces in the start location
		...
		score += scoreKnocked; // Knocking pieces off
		score += numStart * WEIGHT_PIECES_OUT;
		return score;
	}
}
